 ...
 */
class Version20180312150416 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE document ADD created DATETIME NOT NULL, ADD updated DATETIME NOT NULL, ADD content_changed DATETIME DEFAULT NULL, ADD deleted DATETIME DEFAULT NULL');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE document DROP created, DROP updated, DROP content_changed, DROP deleted');
    }
}
