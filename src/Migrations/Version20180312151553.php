 ...
 */
class Version20180312151553 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE document DROP deleted');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE document ADD deleted DATETIME DEFAULT NULL');
    }
}
