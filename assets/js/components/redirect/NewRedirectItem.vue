<template>
  <div>
    <div v-if="this.permissions[0].user">
      <div :is="currentComponent" @redirectItemChosen="setItemType" @goBackStep1="setComponent(previousStep)" :itemType="itemType" :itemExists="false" :permissions="this.permissions" :newForm="true" startMode="edit"></div>
