    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Delete {{ assignee.firstName }} {{ assignee.lastName }}</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
          <p>Are you sure you want to delete {{ assignee.firstName }} {{ assignee.lastName }}? Type the word <strong>"delete"</strong> to confirm.</p>
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-danger" data-dismiss="modal" @click="delItem" :disabled="deleteConfirm != 'delete'">Delete assignee</button>
        </div>
      </div>
    </div>
  </div>
