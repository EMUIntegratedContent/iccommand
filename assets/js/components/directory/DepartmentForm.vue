	...
	computed: {
		...
		departmentSchema: function () {
			return Yup.object().shape({
				...
				state: Yup.string().max(2, "State must be 2 characters or less."),
				zip: Yup.string().max(10, "ZIP code must be 10 characters or less."),
				phone: Yup.string().max(20, "Phone must be 20 characters or less."),
				phoneAlt: Yup.string().max(20, "Phone must be 20 characters or less."),
				fax: Yup.string().max(20, "Fax must be 20 characters or less."),
				email: Yup.string()
