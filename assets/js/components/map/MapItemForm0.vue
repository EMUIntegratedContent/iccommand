  ...
  export default {
    ...
    mounted() {
      window.addEventListener('load',function(){
        ...
        loadGoogleMapsApi({key: 'AIzaSyC5B3IcIel6XCAq4bwyZpxo6bl1pdUQpN8'}).then(function (googleMaps) {


          var map = new googleMaps.Map(document.getElementById('map-canvas'), {
            zoom: 10,
