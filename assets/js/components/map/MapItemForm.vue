            ...
            <div class="tab-content pt-2" id="mapitemTabContent">
                <div class="tab-pane fade show active" id="information" role="tabpanel"
                    ...
                    <form class="form" @submit.prevent="checkForm">
                                        ...
                                        <ul class="nav nav-tabs mb-3" id="pills-tab" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link active" id="pills-bathrooms-tab" data-toggle="pill"
                                                   ...
                                                   aria-selected="true">Bathrooms <span class="badge badge-light">{{ record.bathrooms.length }}</span></a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" id="pills-dining-tab" data-toggle="pill"
                                                   href="#pills-dining" role="tab" aria-controls="pills-dining"
                                                   aria-selected="true">Dining <span class="badge badge-light">{{ record.diningOptions.length }}</span></a>
                                            </li>
                                            <li class="nav-item">
                                            ...
                                            <div class="tab-pane fade pl-4" id="pills-dining" role="tabpanel"
                                                ...
                                                <template v-else>
                                                    <div v-if="record.diningOptions.length > 0">
                                                        <ul>
                                                            <li v-for="dining in record.diningOptions">{{ dining.name
                                                                }}
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    ...
                                                    <div v-if="record.emergencyDevices.length > 0">
                                                        <ul>
                                                            <li v-for="emergency in record.emergencyDevices">{{
                                                                emergency.name }} – {{ emergency.type.name }}
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <div v-else>
                        ...
                        <div v-if="this.$validator.errors.count() > 0" class="alert alert-danger fade show"
                             role="alert">
