      ...
      <div class="card">
        ...
        <div id="collapseBuildings" class="collapse show" aria-labelledby="headingBuildings" data-parent="#accordion">
          <div class="card-body">
              ...
              <table class="table table-hover">
                ...
                <tbody>
                  <tr v-for="item in paginatedBuildings">
                    ...
                    <td><a :href="'/map/items/' + item.id" v-if="userCanEdit"><i class="fa fa-eye"></i></a></td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <paginator v-show="!loadingBuildings" :items="buildings" @itemsPerPageChanged="setPaginatedBuildings"></paginator>
          </div>
        </div>
      </div>
      <div class="card">
        <div class="card-header" id="headingBusses">
          <h5 class="mb-0">
            <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseBusses" aria-expanded="false" aria-controls="collapseBusses">
              Bus Stops
        ...
        <div id="collapseBusses" class="collapse" aria-labelledby="headingBusses" data-parent="#accordion">
          <div class="card-body">
            ...
            <paginator v-show="!loadingBusses" :items="busses" @itemsPerPageChanged="setPaginatedBusses"></paginator>
          </div>
        </div>
      </div>
      <div class="card">
        <div class="card-header" id="headingEmergencyDevices">
          <h5 class="mb-0">
            <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseEmergencyDevices" aria-expanded="false" aria-controls="collapseEmergencyDevices">
              Emergency Devices
        ...
        <div id="collapseEmergencyDevices" class="collapse" aria-labelledby="headingEmergencyDevices" data-parent="#accordion">
          <div class="card-body">
            ...
            <paginator v-show="!loadingEmergencyDevices" :items="emergencyDevices" @itemsPerPageChanged="setPaginatedEmergencyDevices"></paginator>
          </div>
        </div>
      </div>
      <div class="card">
        <div class="card-header" id="headingExhibits">
          <h5 class="mb-0">
            <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseExhibits" aria-expanded="false" aria-controls="collapseExhibits">
              Exhibits
        ...
        <div id="collapseExhibits" class="collapse" aria-labelledby="headingExhibits" data-parent="#accordion">
          <div class="card-body">
            ...
            <paginator v-show="!loadingExhibits" :items="exhibits" @itemsPerPageChanged="setPaginatedExhibits"></paginator>
          </div>
        </div>
      </div>
      <div class="card">
        <div class="card-header" id="headingParking">
          <h5 class="mb-0">
            <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseParking" aria-expanded="false" aria-controls="collapseParking">
            Parking Lots
        ...
        <div id="collapseParking" class="collapse" aria-labelledby="headingParking" data-parent="#accordion">
          <div class="card-body">
              ...
              <table class="table table-hover">
                ...
                <tbody>
                  <tr v-for="item in paginatedParkingLots">
                    ...
                    <td>{{ item.spaces }}</td>
                    <td>
                      <span v-for="type in item.parkingTypes" class="badge badge-dark">{{ type.name }}</span>
                    </td>
                    <td><a :href="'/map/items/' + item.id" v-if="userCanEdit"><i class="fa fa-eye"></i></a></td>
                  </tr>
                </tbody>
            ...
            <paginator v-show="!loadingParkingLots" :items="parkingLots" @itemsPerPageChanged="setPaginatedParkingLots"></paginator>
          </div>
        </div>
      </div>
    </div>
      ...
      methods: {
        fetchMapItems: function(){
          ...
          .then(function (response) {
            ...
            if(self.buildings.length == 0){ self.loadingBuildings = false }
            if(self.busses.length == 0){ self.loadingBusses = false }
            if(self.emergencyDevices.length == 0){ self.loadingEmergencyDevices = false }
            if(self.exhibits.length == 0){ self.loadingExhibits = false }
            if(self.parkingLots.length == 0){ self.loadingParkingLots = false }
          })
          // fail
